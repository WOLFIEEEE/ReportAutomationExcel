...
def know_the_Columns(workbook, sheet_name, column_name):
    ...
    return column_index
def table_creation_for_severity(workbook, sheetname, last_row_num):
    # Select the sheet by name
    ws = workbook[sheetname]

    H_column = know_the_Columns(workbook, "Execution Summary", "High")
    M_column = know_the_Columns(workbook, "Execution Summary", "Medium")
    L_column = know_the_Columns(workbook, "Execution Summary", "Low")
    C_column = know_the_Columns(workbook, "Execution Summary", "Critical")
    ...
    tab = Table(displayName="DefectCountTable", ref=table_range)
    ...
    create_column_chart_severity(workbook, sheetname,"DefectCountTable")
